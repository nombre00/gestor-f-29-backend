...
def parse_libro_remuneraciones(bytes_content: bytes) -> LibroRemuneraciones:
    wb = openpyxl.load_workbook(io.BytesIO(bytes_content), data_only=True)  # Generamos un workbook que contiene los datos del excel.
